    ...
    class Program
    {
        ...
        static void Main(string[] args)
		{
	        ...
	        do
	        {
		        ...
		        CGUIViewImageLayer layer2 = viewImageSrc.GetLayer(1);
		        CGUIViewImageLayer layer3 = viewImageSrc.GetLayer(2);
		        ...
		        CGUIViewImageLayer layer = fliImageDrawing.GetLayer();
