    ...
    class CircleArrayGauge
	{
        ...
        static void Main(string[] args)
        {
			...
			do
			{
				...
				if((res = viewImage.Create(300, 300, 600, 600)).IsFail())
				{
				...
				CCircleArrayGauge circleGauge = new CCircleArrayGauge();
				...
				circleGauge.SetSamplingStep(1.0);
				...
				circleGauge.SetOutliersThreshold(3.0);
				...
				circleGauge.SetTransitionType(CCircleGauge.ETransitionType.BrightToDark);
				...
				circleGauge.SetTransitionChoice(CCircleGauge.ETransitionChoice.LargestAmplitude);
