...
namespace MorphologyTopHat
{
	class MorphologyTopHat_Region
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				if((res = (morphologyTopHat.Execute())).IsFail())
				{
				...
				if((res = (arrLayer[(int)EType.Region].DrawFigureImage(flrRegion, EColor.LIME))).IsFail())
					ErrorPrint(res, "Failed to draw figure.\n");
