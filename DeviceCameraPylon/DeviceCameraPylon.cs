...
namespace FLImagingExamplesCSharp
{
    ...
    class DeviceCameraPylon
	{
        ...
        static void Main(string[] args)
		{
			...
			// Pylon 카메라 선언 // Declare Pylon camera
			CDeviceCameraPylon camPylon = new CDeviceCameraPylon();
	        ...
	        do
			{
		        ...
		        else
				{
			        ...
			        if(eConnectionMethod == CDeviceGenICamBase.EConnectionMethod.SerialNumber)
				        ...
				        camPylon.SetSerialNumber(strConnection);
			        else
				        // IP 주소를 설정합니다. // Set the IP address.
                        camPylon.SetIPAddress(strConnection);
		        }

		        // 카메라를 초기화 합니다. // Initialize the camera.
                drResult = camPylon.Initialize();
                if (drResult.IsFail())
				{
