...
{
	class SaliencyMapSpectralBased
	{
		...
		static void Main(string[] args)
		{
            ...
            do
			{
				...
				// SaliencyMapSpectralBased 객체 생성 // Create SaliencyMapSpectralBased object
				CSaliencyMapSpectralBased saliencyMap = new CSaliencyMapSpectralBased();
				...
				{
					//ErrorPrint(res, "Failed to execute Saliency Map Spectral Based.");
