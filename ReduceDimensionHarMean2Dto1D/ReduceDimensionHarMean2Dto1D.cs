...
{
	class ReduceDimensionHarMean2Dto1D
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				CResult res;
				// 이미지 로드 // Load image
				if((res = fliSourceImage.Load("../../ExampleImages/ReduceDimensionHarMean2Dto1D/Source.flif")).IsFail())
				{
				...
				reduceDimensionHarMean2Dto1D.SetDestinationImage(ref fliDestinationImageX);

				// 축소 차원 설정 // Set reduction dimension
				reduceDimensionHarMean2Dto1D.SetReductionDimension(CReduceDimensionHarMean2Dto1D.EReductionDimension.X);
				...
				// Destination 이미지 설정 // Set destination image
				reduceDimensionHarMean2Dto1D.SetDestinationImage(ref fliDestinationImageY);

				// 축소 차원 설정 // Set reduction dimension
				reduceDimensionHarMean2Dto1D.SetReductionDimension(CReduceDimensionHarMean2Dto1D.EReductionDimension.Y);
