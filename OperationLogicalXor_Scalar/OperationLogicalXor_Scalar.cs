...
{
    class OperationLogicalXor_Scalar
	{
        ...
        static void Main(string[] args)
		{
            ...
            do
			{
                ...
                if ((res = layerDestination1.DrawTextCanvas(flpPoint, "Destination1 Image(LogicalXor 0)", EColor.YELLOW, EColor.BLACK, 25)).IsFail())
				{
                    ErrorPrint(res, "Failed to draw text. \n");
                    break;
                }

                if ((res = layerDestination2.DrawTextCanvas(flpPoint, "Destination2 Image(LogicalXor 255)", EColor.YELLOW, EColor.BLACK, 25)).IsFail())
				{
                    ErrorPrint(res, "Failed to draw text. \n");
                    break;
                }
