	...
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				if((eResult = (arrLayer[(int)EType.Destination1].DrawTextCanvas(flpZero, "Destination1 Image(ScaledDivide 192)", EColor.YELLOW, EColor.BLACK, 18))).IsFail())
				{
					ErrorPrint(eResult, "Failed to draw text.\n");
					break;
				}

				if((eResult = (arrLayer[(int)EType.Destination2].DrawTextCanvas(flpZero, "Destination2 Image(ScaledDivide 512)", EColor.YELLOW, EColor.BLACK, 18))).IsFail())
				{
					ErrorPrint(eResult, "Failed to draw text.\n");
					break;
				}
