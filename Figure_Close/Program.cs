	...
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				if((res = flrgSourceFig.Close(i64HalfSize, i64HalfSize, out flfaResult1)).IsFail())
				{
				...
				if((res = flrgSourceFig.Close(i64HalfSize, i64HalfSize, out flfaResult2, EKernelShape.Circle)).IsFail())
				{
					ErrorPrint(res, "Failed to calculate.\n");
					break;
				}
