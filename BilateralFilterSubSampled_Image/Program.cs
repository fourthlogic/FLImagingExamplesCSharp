...
namespace BilateralFilterSubSampled
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
			...
			do
	        {
                ...
                if ((eResult = fliSourceImage.Load("../../ExampleImages/BilateralFilterSubSampled/cat_450x480.flif")).IsFail())
                {
                ...
                if ((eResult = fliOperandImage.Load("../../ExampleImages/BilateralFilterSubSampled/cat_450x480.flif")).IsFail())
                {
                    ErrorPrint(eResult, "Failed to load the image file. \n");
                    break;
                }
                ...
                if ((eResult = fliDestinationImage.Load("../../ExampleImages/BilateralFilterSubSampled/cat_450x480.flif")).IsFail())
                {
                    ErrorPrint(eResult, "Failed to load the image file. \n");
                    break;
                }
				...
				// BilateralFilterSubSampled 객체 생성 // Create BilateralFilterSubSampled object
				CBilateralFilterSubSampled bilateralFilterSubSampled = new CBilateralFilterSubSampled();

				// Source 이미지 설정 // Set the source image
				bilateralFilterSubSampled.SetSourceImage(ref fliSourceImage);

				// Operand 이미지 설정 // Set the operand image
				bilateralFilterSubSampled.SetOperandImage(ref fliOperandImage);

				// Destination 이미지 설정 // Set the destination image
				bilateralFilterSubSampled.SetDestinationImage(ref fliDestinationImage);
		        ...
		        {
                    ErrorPrint(eResult, "Failed to execute Bilateral Filter SubSampled. \n");
                    break;
		        }
