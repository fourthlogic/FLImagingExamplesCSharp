    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
			...
			do
	        {
                ...
                if ((res = fliSourceImage.Load("../../ExampleImages/BilateralFilterSubSampled/cat_450x480.flif")).IsFail())
                {
                ...
                if ((res = fliOperandImage.Load("../../ExampleImages/BilateralFilterSubSampled/cat_450x480.flif")).IsFail())
                {
                    ErrorPrint(res, "Failed to load the image file. \n");
                    break;
                }
                ...
                if ((res = fliDestinationImage.Load("../../ExampleImages/BilateralFilterSubSampled/cat_450x480.flif")).IsFail())
                {
                    ErrorPrint(res, "Failed to load the image file. \n");
                    break;
                }
		        ...
		        {
                    ErrorPrint(res, "Failed to execute Bilateral Filter SubSampled. \n");
                    break;
		        }
