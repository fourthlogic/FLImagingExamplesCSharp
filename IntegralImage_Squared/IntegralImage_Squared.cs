	...
	class IntegralImage_Squared
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				// ECalculationMode.Squared : ax^2 형태의 제곱 누적합 // ECalculationMode.Squared : Squared sum (ax^2)
				integralImage.SetCalculationMode(CIntegralImage.ECalculationMode.Squared);
