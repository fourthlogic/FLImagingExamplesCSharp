	...
	class OperationSubtract_Image
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				// 이미지 로드 // Load image
				if((res = (arrFliImage[1].Load("../../ExampleImages/OperationSubtract/Sunset.flif"))).IsFail())
				{
					ErrorPrint(res, "Failed to load the image file.\n");
					break;
				}
				...
				operationSubtract.SetOperandImage(ref arrFliImage[1]);
