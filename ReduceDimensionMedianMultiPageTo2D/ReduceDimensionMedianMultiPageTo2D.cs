...
namespace ReduceDimensionMedianMultiPageTo2D
{
	class ReduceDimensionMedianMultiPageTo2D
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				CResult res;
				// 이미지 로드 // Load image
				if((res = fliSourceImage.Load("../../ExampleImages/ReduceDimensionMedianMultiPageTo2D/Source.flif")).IsFail())
				{
				...
				CReduceDimensionMedianMultiPageTo2D reduceDimensionMedianMultiPageTo2D = new CReduceDimensionMedianMultiPageTo2D();

				// Source 이미지 설정 // Set source image 
				reduceDimensionMedianMultiPageTo2D.SetSourceImage(ref fliSourceImage);

				// Destination 이미지 설정 // Set destination image
				reduceDimensionMedianMultiPageTo2D.SetDestinationImage(ref fliDestinationImage);
