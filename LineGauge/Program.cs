	...
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			{ 
				...
				CFLLine<double> measureRegion = new CFLLine<double>(119.284786, 267.519218, 158.658237, 267.665332);
				...
				lineGauge.GetMeasuredObject(out fllResult, 0);
