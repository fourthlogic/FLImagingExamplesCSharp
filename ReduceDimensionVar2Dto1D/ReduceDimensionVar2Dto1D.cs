...
{
	class ReduceDimensionVar2Dto1D
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				CResult res;
				// 이미지 로드 // Load image
				if((res = fliSourceImage.Load("../../ExampleImages/ReduceDimensionVar2Dto1D/Source.flif")).IsFail())
				{
				...
				CReduceDimensionVar2Dto1D reduceDimensionVar2Dto1D = new CReduceDimensionVar2Dto1D();

				// Source 이미지 설정 // Set source image 
				reduceDimensionVar2Dto1D.SetSourceImage(ref fliSourceImage);

				// Destination 이미지 설정 // Set destination image
				reduceDimensionVar2Dto1D.SetDestinationImage(ref fliDestinationImageX);

				// 축소 차원 설정 // Set reduction dimension
				reduceDimensionVar2Dto1D.SetReductionDimension(CReduceDimensionVar2Dto1D.EReductionDimension.X);
				...
				// Destination 이미지 설정 // Set destination image
				reduceDimensionVar2Dto1D.SetDestinationImage(ref fliDestinationImageY);

				// 축소 차원 설정 // Set reduction dimension
				reduceDimensionVar2Dto1D.SetReductionDimension(CReduceDimensionVar2Dto1D.EReductionDimension.Y);
