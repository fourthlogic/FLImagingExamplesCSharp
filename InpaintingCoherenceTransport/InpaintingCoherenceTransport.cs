...
{
    class InpaintingCoherenceTransport
	{
        ...
        static void Main(string[] args)
		{
            ...
            do
			{
                ...
                if ((res = arrFliImage[0].Load("../../ExampleImages/InpaintingCoherenceTransport/owl.flif")).IsFail())
				{
				...
				if((res = flrInpaintingRegion.Load("../../ExampleImages/InpaintingCoherenceTransport/InpaintingRegionOwl.fig")).IsFail())
				{
