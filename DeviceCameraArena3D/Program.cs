    ...
    public class CDeviceEventImageEx : CDeviceEventImageBase
    {
        ...
        public override void OnAcquisition(CDeviceImageBase pDeviceImage)
        {
            do
            {
                ...
                CDeviceCameraArena3D camera = pDeviceImage as CDeviceCameraArena3D;
        ...
        static void Main(string[] args)
        {
	        ...
	        do
	        {
		        ...
		        if(bAutoDetect)
		        {
                    ...
                    drResult = camArena3D.GetAutoDetectCameraSerialNumbers(out listSerialNumbers);
