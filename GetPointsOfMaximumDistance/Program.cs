...
namespace GetPointsOfMaximumDistance
{
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				Dst1Layer0.DrawTextCanvas(new TPoint<double>(0, 20), "Maximum Distance", EColor.CYAN, EColor.BLACK);
				...
				Dst1Layer0.DrawFigureImage(fllMax1, EColor.CYAN);
				Dst1Layer0.DrawTextImage(fllMax1.GetCenter(), String.Format("{0:.000}", f64MaximumDistance1), EColor.CYAN, EColor.BLACK, 12, false, 0, EGUIViewImageTextAlignment.RIGHT_TOP);
				...
				Dst2Layer0.DrawFigureImage(fllMax2, EColor.CYAN);
				Dst2Layer0.DrawTextImage(fllMax2.GetCenter(), String.Format("{0:.000}", f64MaximumDistance2), EColor.CYAN, EColor.BLACK, 12, false, 0, EGUIViewImageTextAlignment.RIGHT_TOP);
