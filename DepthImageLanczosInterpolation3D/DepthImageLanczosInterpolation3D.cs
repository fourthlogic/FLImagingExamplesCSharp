...
{
	class DepthImageLanczosInterpolation3D
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				CDepthImageLanczosInterpolation3D depthImageLanczosInterpolation3D = new CDepthImageLanczosInterpolation3D();

				// Source 이미지 설정 // Set source image 
				depthImageLanczosInterpolation3D.SetSourceImage(ref fliSourceImage);

				// Destination 이미지 설정 // Set destination image
				depthImageLanczosInterpolation3D.SetDestinationImage(ref fliDestinationImage);
