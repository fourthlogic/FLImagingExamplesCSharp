    ...
    class OperationLogicalAnd_Image
	{
        ...
        static void Main(string[] args)
		{
			...
			do
			{
                ...
                COperationLogicalAnd operationLogicalAnd = new COperationLogicalAnd();

				// Source 이미지 설정 // Set the source image
				operationLogicalAnd.SetSourceImage(ref fliSourceImage);

				// Operand 이미지 설정 // Set the operand image
				operationLogicalAnd.SetOperandImage(ref fliOperandImage);

				// Destination 이미지 설정 // Set the destination image
				operationLogicalAnd.SetDestinationImage(ref fliDestinationImage);

				// Image Operation 소스로 설정 // Set Operation Source to image
				operationLogicalAnd.SetOperationSource(EOperationSource.Image);
				...
				operationLogicalAnd.EnableFillBlankColorMode(false);
