	...
	class GeometricMatchMulti_SaveLoad
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				FLGeometricMatchMultiLoad.SetContrastOption(FLImagingCLR.AdvancedFunctions.EMatchContrastOption.Normal);
				...
				for(long i = 0; i < i64ResultCount; ++i)
				{
					...
					FLGeometricMatchMultiLoad.GetResultDetectedFeature(i, ref flfaResultPoints);
