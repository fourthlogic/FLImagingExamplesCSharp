...
{
	class ReduceDimensionMode2Dto1D
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				CResult res;
				// 이미지 로드 // Load image
				if((res = fliSourceImage.Load("../../ExampleImages/ReduceDimensionMode2Dto1D/Source.flif")).IsFail())
				{
				...
				CReduceDimensionMode2Dto1D reduceDimensionMode2Dto1D = new CReduceDimensionMode2Dto1D();

				// Source 이미지 설정 // Set source image 
				reduceDimensionMode2Dto1D.SetSourceImage(ref fliSourceImage);

				// Destination 이미지 설정 // Set destination image
				reduceDimensionMode2Dto1D.SetDestinationImage(ref fliDestinationImageX);

				// 축소 차원 설정 // Set reduction dimension
				reduceDimensionMode2Dto1D.SetReductionDimension(CReduceDimensionMode2Dto1D.EReductionDimension.X);
				...
				// Destination 이미지 설정 // Set destination image
				reduceDimensionMode2Dto1D.SetDestinationImage(ref fliDestinationImageY);

				// 축소 차원 설정 // Set reduction dimension
				reduceDimensionMode2Dto1D.SetReductionDimension(CReduceDimensionMode2Dto1D.EReductionDimension.Y);
