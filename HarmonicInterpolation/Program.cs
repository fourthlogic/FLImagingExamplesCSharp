...
namespace HarmonicInterpolation
{
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				if((eResult = (harmo.Execute())).IsFail())
				{
				...
				if((eResult = (arrLayer[(int)EType.Destination].DrawTextCanvas(flpZero, "Destination Image (Harmonic)", EColor.YELLOW, EColor.BLACK, 20))).IsFail())
				{
					ErrorPrint(eResult, "Failed to draw text.\n");
					break;
				}
