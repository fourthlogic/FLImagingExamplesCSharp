...
{
	class OperationComplexDivide_Scalar
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				// Operation Divide 객체 생성 // Create Operation Complex Divide object
				...
				CMultiVar<double> mvScalar = new CMultiVar<double>(5, 1);
				...
				if((res = layerDestination.DrawTextCanvas(flpPoint, "Destination Image(Divided by 5 + 1i)", EColor.YELLOW, EColor.BLACK, 20)).IsFail())
				{
					ErrorPrint(res, "Failed to draw text. \n");
					break;
				}
