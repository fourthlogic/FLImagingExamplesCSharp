    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
			...
			do
	        {
                ...
                if ((eResult = fliSourceImage.Load("../../ExampleImages/OperationLogicalNand/circle.flif")).IsFail())
                {
                ...
                if ((eResult = fliOperandImage.Load("../../ExampleImages/OperationLogicalNand/square.flif")).IsFail())
                {
                    ErrorPrint(eResult, "Failed to load the image file. \n");
                    break;
                }
                ...
                {
                    ErrorPrint(eResult, "Failed to execute Operation LogicalNand.");
                    break;
                }
