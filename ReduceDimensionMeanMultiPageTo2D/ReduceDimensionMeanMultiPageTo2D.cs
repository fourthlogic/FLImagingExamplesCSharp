...
namespace ReduceDimensionMeanMultiPageTo2D
{
	class ReduceDimensionMeanMultiPageTo2D
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				CResult res;
				// 이미지 로드 // Load image
				if((res = fliSourceImage.Load("../../ExampleImages/ReduceDimensionMeanMultiPageTo2D/Source.flif")).IsFail())
				{
				...
				CReduceDimensionMeanMultiPageTo2D reduceDimensionMeanMultiPageTo2D = new CReduceDimensionMeanMultiPageTo2D();

				// Source 이미지 설정 // Set source image 
				reduceDimensionMeanMultiPageTo2D.SetSourceImage(ref fliSourceImage);

				// Destination 이미지 설정 // Set destination image
				reduceDimensionMeanMultiPageTo2D.SetDestinationImage(ref fliDestinationImage);
