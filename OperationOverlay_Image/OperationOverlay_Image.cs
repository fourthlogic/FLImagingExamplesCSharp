	...
	class OperationOverlay_Image
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				if((res = arrFliImage[(int)EType.Source].Load("../../ExampleImages/OperationOverlay/Sea.flif")).IsFail())
				{
				...
				if((res = arrFliImage[(int)EType.Operand].Load("../../ExampleImages/OperationOverlay/Moon.flif")).IsFail())
				{
					ErrorPrint(res, "Failed to load the image file.\n");
					break;
				}
