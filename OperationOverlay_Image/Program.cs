	...
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				if((eResult = arrFliImage[(int)EType.Source].Load("../../ExampleImages/OperationOverlay/Sea.flif")).IsFail())
				{
				...
				if((eResult = arrFliImage[(int)EType.Operand].Load("../../ExampleImages/OperationOverlay/Moon.flif")).IsFail())
				{
					ErrorPrint(eResult, "Failed to load the image file.\n");
					break;
				}
				...
				if((eResult = (overlay.Execute())).IsFail())
				{
