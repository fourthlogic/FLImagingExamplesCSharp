	...
	class BlobSubsampled_Min_Max
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				// Blob 결과의 Min, Max 을 얻어오기 위한 Statistics 객체 선언
				...
				// 각 Contour에 맞는 Min, Max 을 얻어오는 코드
				for(Int64 i = 0; i < i64ResultCount; ++i)
				{
					...
					strMin = String.Format("No. {0} Min : {1}", i, mvMin.GetAt(0));
					...
					strMax = String.Format("No. {0} Max : {1}", i, mvMax.GetAt(0));
