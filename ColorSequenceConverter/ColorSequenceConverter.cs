...
namespace ColorSequenceConverter
{
	class ColorSequenceConverter
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				CResult res;
				// 이미지 로드 // Load image
				if((res = fliSourceImage.Load("../../ExampleImages/ColorSequenceConverter/BGR.flif")).IsFail())
				{
				...
				CColorSequenceConverter colorSequenceConverter = new CColorSequenceConverter();

				// Source 이미지 설정 // Set source image 
				if((res = colorSequenceConverter.SetSourceImage(ref fliSourceImage)).IsFail())
				{
				...
				if((res = colorSequenceConverter.SetDestinationImage(ref fliConvertedImage)).IsFail())
				{
				...
				if((res = (colorSequenceConverter.SetColorSequence(EColorSequence.RGB))).IsFail())
				{
