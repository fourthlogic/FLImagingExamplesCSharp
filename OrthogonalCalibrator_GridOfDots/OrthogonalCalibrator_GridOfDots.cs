...
{
	class OrthogonalCalibrator_GridOfDots
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				if((res = fliLearnImage.Load("../../ExampleImages/OrthogonalCalibrator/Orthogonal_GridOfDots.flif")).IsFail())
				{
				...
				if((res = fliSourceImage.Load("../../ExampleImages/OrthogonalCalibrator/Orthogonal_GridOfDots.flif")).IsFail())
				{
					ErrorPrint(res, "Failed to load the image file.");
					break;
				}
