...
namespace MorphologyOpen
{
	class MorphologyOpen_Kernel
	{
		...
		static void Main(string[] args)
		{
			...
			{
				// 이미지 로드 // Load image
				if((res = arrFliImage[(int)EType.Source].Load("../../ExampleImages/Morphology/Chip_Noise2.flif")).IsFail())
				{
				...
				morphologyOpen.SetKernelShape(EKernelShape.Circle);
