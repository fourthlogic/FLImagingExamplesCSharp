	...
	class ShapeMatchLine
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				CShapeMatchLine shapeMatch = new CShapeMatchLine();
				...
				shapeMatch.SetTransitionType(CShapeMatchLine.ETransitionType.DarkToBright);
				...
				for(long i = 0; i < i64ResultCount; ++i)
				{
					...
					if((res = layer.DrawFigureImage(matchResult.fllResultObject, EColor.CYAN, 3)).IsFail())
					{
