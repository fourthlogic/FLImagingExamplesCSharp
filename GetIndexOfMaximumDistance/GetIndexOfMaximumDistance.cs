...
{
	class GetIndexOfMaximumDistance
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				layerDst1.DrawTextCanvas(new TPoint<double>(0, 20), "Index of Maximum Distance", EColor.CYAN, EColor.BLACK);
				layerDst2.DrawTextCanvas(new TPoint<double>(0, 20), "Index of Maximum Distance", EColor.CYAN, EColor.BLACK);
				...
				if((res = flpaSource1.GetIndexOfMaximumDistance(flcDestination1, ref flfaResultSrc1)).IsFail())
				{
				...
				if((res = flfaSource2.GetIndexOfMaximumDistance(flfaDestination2, ref flfaResultSrc2, true, true, ref flfaResultDst2)).IsFail())
				{
					ErrorPrint(res, "Failed to process.\n");
					break;
				}
