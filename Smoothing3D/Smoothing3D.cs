	...
	class Smoothing3D
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				if((eResult = fl3DOSourceObject.Load("../../ExampleImages/Smoothing3D/Smoothing3DExample.ply")).IsFail())
				{
				...
				smoothing3D.SetDestinationObject(ref fl3DODestinationObject);
				// Source object 설정 // Set the source object
				smoothing3D.SetSourceObject(ref fl3DOSourceObject);
