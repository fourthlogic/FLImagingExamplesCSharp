	...
	class SumModifiedLaplacian
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				CSumModifiedLaplacian sumModifiedLaplacian = new CSumModifiedLaplacian();

				// Source 이미지 1 설정 // Set the source1 image
				sumModifiedLaplacian.SetSourceImage(ref fliSrcImage1);

				//Threshold 설정 //Set Threshold
				sumModifiedLaplacian.SetThreshold(5.0);

				// 앞서 설정된 파라미터 대로 알고리즘 수행 // Execute algorithm according to previously set parameters
				if((res = sumModifiedLaplacian.Execute()).IsFail())
				{
				...
				sumModifiedLaplacian.SetSourceImage(ref fliSrcImage2);
				...
				sumModifiedLaplacian.SetSourceImage(ref fliSrcImage3);
				...
				// 결과 점수 획득 // Get Result Score
				double f64Score3 = sumModifiedLaplacian.GetResultScore();
