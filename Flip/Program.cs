    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                if ((arrViewImage[0].SynchronizePointOfView(arrViewImage[1])).IsFail())
                {
                ...
                // 두 이미지 뷰의 시점을 동기화 한다 // Synchronize the viewpoints of the two image views
                if ((arrViewImage[0].SynchronizePointOfView(arrViewImage[2])).IsFail())
                {
                    Console.WriteLine("Failed to synchronize view\n");
                    break;
                }
                ...
                // 두 이미지 뷰의 시점을 동기화 한다 // Synchronize the viewpoints of the two image views
                if ((arrViewImage[0].SynchronizePointOfView(arrViewImage[3])).IsFail())
                {
                    Console.WriteLine("Failed to synchronize view\n");
                    break;
                }
                ...
                if ((arrViewImage[0].SynchronizeWindow(arrViewImage[1])).IsFail())
                {
                ...
                // 두 이미지 뷰 윈도우의 위치를 맞춤 // Synchronize the positions of the two image view windows
                if ((arrViewImage[0].SynchronizeWindow(arrViewImage[2])).IsFail())
                {
                    Console.WriteLine("Failed to synchronize window.\n");
                    break;
                }
                ...
                // 두 이미지 뷰 윈도우의 위치를 맞춤 // Synchronize the positions of the two image view windows
                if ((arrViewImage[0].SynchronizeWindow(arrViewImage[3])).IsFail())
                {
                    Console.WriteLine("Failed to synchronize window.\n");
                    break;
                }
