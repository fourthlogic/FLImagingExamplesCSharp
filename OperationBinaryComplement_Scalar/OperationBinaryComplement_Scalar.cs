...
{
    class OperationBinaryComplement_Scalar
	{
        ...
        static void Main(string[] args)
		{
			...
			do
			{
                ...
                if ((res = fliSourceImage.Load("../../ExampleImages/OperationBinaryComplement/gradation.flif")).IsFail())
				{
		        ...
		        if ((res = layerDestination.DrawTextCanvas(flpPoint, "Source & Destination Image", EColor.YELLOW, EColor.BLACK, 20)).IsFail())
				{
                    ErrorPrint(res, "Failed to draw text. \n");
		        	break;
		        }
