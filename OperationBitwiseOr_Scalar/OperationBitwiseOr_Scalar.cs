...
{
    class OperationBitwiseOr_Scalar
	{
        ...
        static void Main(string[] args)
		{
			...
			do
			{
                ...
                if ((res = fliSourceImage.Load("../../ExampleImages/OperationBitwiseOr/Sun.flif")).IsFail())
				{
                ...
                if ((res = layerDestination1.DrawTextCanvas(flpPoint, "Destination1 Image(BitwiseOr 64)", EColor.YELLOW, EColor.BLACK, 20)).IsFail())
				{
                    ErrorPrint(res, "Failed to draw text. \n");
                    break;
                }

                if ((res = layerDestination2.DrawTextCanvas(flpPoint, "Destination2 Image(BitwiseOr 128)", EColor.YELLOW, EColor.BLACK, 20)).IsFail())
				{
                    ErrorPrint(res, "Failed to draw text. \n");
                    break;
                }
