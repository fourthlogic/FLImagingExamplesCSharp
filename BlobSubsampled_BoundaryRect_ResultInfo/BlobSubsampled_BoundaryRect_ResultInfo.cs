...
namespace Blob
{
	class BlobSubsampled_BoundaryRect_ResultInfo
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				if((res = sBlobSubsampled.Execute()).IsFail())
				{
				...
				if((res = sBlobSubsampled.Filter(CBlobSubsampled.EFilterItem.Area, 500, ELogicalCondition.LessEqual)).IsFail())
				{
				...
				if((res = sBlobSubsampled.GetResultBoundaryRects(ref flfaBoundaryRects)).IsFail())
				{
