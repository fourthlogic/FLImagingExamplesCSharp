	...
	class ReduceDimensionGeoMeanMultiPageTo2D
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				CResult res;
				// 이미지 로드 // Load image
				if((res = fliSourceImage.Load("../../ExampleImages/ReduceDimensionGeoMeanMultiPageTo2D/Source.flif")).IsFail())
				{
				...
				CReduceDimensionGeoMeanMultiPageTo2D reduceDimensionGeoMeanMultiPageTo2D = new CReduceDimensionGeoMeanMultiPageTo2D();

				// Source 이미지 설정 // Set source image 
				reduceDimensionGeoMeanMultiPageTo2D.SetSourceImage(ref fliSourceImage);

				// Destination 이미지 설정 // Set destination image
				reduceDimensionGeoMeanMultiPageTo2D.SetDestinationImage(ref fliDestinationImage);
