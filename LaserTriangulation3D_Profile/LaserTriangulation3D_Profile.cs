	...
	class LaserTriangulation3D_Profile
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				if((res = fliSourceImage.Load("../../ExampleImages/LaserTriangulation3D/SrcProfile.flif")).IsFail())
				{
				...
				if((res = laserTriangulation3D.SetSourceType(CLaserTriangulation3D.ESourceType.Profile)).IsFail())
				{
