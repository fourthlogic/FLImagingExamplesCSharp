    ...
    class OperationBitwiseNor_Image
	{
        ...
        static void Main(string[] args)
		{
			...
			do
			{
                ...
                operationBitwiseNor.SetSourceImage(ref fliSourceImage);

                // Operand 이미지 설정 // Set the operand image
        		operationBitwiseNor.SetOperandImage(ref fliOperandImage);

		        // Destination 이미지 설정 // Set the destination image
		        operationBitwiseNor.SetDestinationImage(ref fliDestinationImage);

                // Image Operation 소스로 설정 // Set Operation Source to image
                operationBitwiseNor.SetOperationSource(EOperationSource.Image);
