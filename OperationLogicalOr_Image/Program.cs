    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
			...
			do
            {
                ...
                if ((eResult = fliSourceImage.Load("../../ExampleImages/OperationLogicalOr/Cat.flif")).IsFail())
                {
                ...
                if ((eResult = fliOperandImage.Load("../../ExampleImages/OperationLogicalOr/Space.flif")).IsFail())
                {
                    ErrorPrint(eResult, "Failed to load the image file. \n");
                    break;
                }
                ...
                {
                    ErrorPrint(eResult, "Failed to execute operation logical or. \n");
                    break;
                }
