	...
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				ocr.SetModelVersion(CStringBasedOCRDL.EModelVersion.FLNet_V1_32_256);
				...
				// 학습을 종료할 조건식 설정. Validation 값이 1.0 이상인 경우 학습 종료한다.
				// Set Conditional Expression to End Learning. If the validation value is 1.0 or higher, end the learning.
				ocr.SetLearningStopCondition("metric >= 1 & map >= 1");
