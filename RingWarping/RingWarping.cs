    ...
    class RingWarping
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				CFLDoughnut<double> fldSourceROI = new CFLDoughnut<double> (257.071130, 257.071130, 216.368201, 118.521494, 0.000000, -17.159659, 213.494067, ERadialShapeType.Sector);
				// Source 이미지 관심 영역 설정
