	...
	class DepthImageLinearInterpolation3D
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				// Depth Image Linear Interpolation 3D 객체 생성 // Create Depth Image Linear Interpolation 3D object
				CDepthImageLinearInterpolation3D depthImageLinearInterpolation3D = new CDepthImageLinearInterpolation3D();

				// Source 이미지 설정 // Set source image 
				depthImageLinearInterpolation3D.SetSourceImage(ref fliSourceImage);
				...
				{
					ErrorPrint(res, "Failed to execute Depth Image Linear Interpolation 3D. \n");
					break;
				}
