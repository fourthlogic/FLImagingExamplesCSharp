...
namespace FLImagingExamplesCSharp
{
	...
	public class CDeviceEventImageEx : CDeviceEventImageBase
	{
        ...
        public override void OnAcquisition(CDeviceImageBase pDeviceImage)
		{
            do
			{
                ...
                CDeviceCameraPhoXi camera = pDeviceImage as CDeviceCameraPhoXi;
    ...
    class DeviceCameraPhoXi
	{
        ...
        static void Main(string[] args)
		{
			...
			// PhoXi 카메라 선언 // Declare PhoXi camera
			CDeviceCameraPhoXi camPhoXi = new CDeviceCameraPhoXi();
	        ...
	        do
			{
		        ...
		        if(bAutoDetect)
				{
                    ...
                    drResult = camPhoXi.GetAutoDetectCameraSerialNumbers(ref listSerialNumbers);
