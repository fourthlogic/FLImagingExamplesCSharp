...
namespace ReduceDimensionMinMultiPageTo2D
{
	class ReduceDimensionMinMultiPageTo2D
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				CResult res;
				// 이미지 로드 // Load image
				if((res = fliSourceImage.Load("../../ExampleImages/ReduceDimensionMinMultiPageTo2D/Source.flif")).IsFail())
				{
				...
				CReduceDimensionMinMultiPageTo2D reduceDimensionMinMultiPageTo2D = new CReduceDimensionMinMultiPageTo2D();

				// Source 이미지 설정 // Set source image 
				reduceDimensionMinMultiPageTo2D.SetSourceImage(ref fliSourceImage);

				// Destination 이미지 설정 // Set destination image
				reduceDimensionMinMultiPageTo2D.SetDestinationImage(ref fliDestinationImage);
