	...
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				if((res = flrgSourceFig.Open(i64KernelSize, i64KernelSize, out flfaResult1)).IsFail())
				{
				...
				if((res = flrgSourceFig.Open(i64KernelSize, i64KernelSize, out flfaResult2, EKernelShape.Circle)).IsFail())
				{
					ErrorPrint(res, "Failed to calculate.\n");
					break;
				}
				...
				if((res = flrgSourceFig.Open(fleKernel, out flfaResult3)).IsFail())
				{
					ErrorPrint(res, "Failed to calculate.\n");
					break;
				}
