    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                CMorphologyErode morphologyErode = new CMorphologyErode();
                // Source 이미지 설정 // Set the source image
                morphologyErode.SetSourceImage(ref arrFliImage[(int)EType.Source]);
                // Source ROI 설정 // Set the Source ROI
                morphologyErode.SetSourceROI(flrROI);

                // Destination 이미지 설정 // Set the destination image
                morphologyErode.SetDestinationImage(ref arrFliImage[(int)EType.Destination]);
				...
				morphologyErode.SetKernel(flrRegion);

                // 앞서 설정된 파라미터 대로 알고리즘 수행 // Execute algorithm according to previously set parameters
                if ((eResult = (morphologyErode.Execute())).IsFail())
                {
