...
namespace MedianWeightedFilter
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
				...
				if (( eResult = arrFliImage[0].Load("../../ExampleImages/MedianFilter/Chip_Noise.flif")).IsFail())
                {
                ...
                {
                    ErrorPrint(eResult,"Failed to execute weighted median.");
                    break;
                }
                ...
                if (( eResult = arrLayer[1].DrawTextCanvas(tpPosition, "MedianWeighted1 Gauss", EColor.YELLOW, EColor.BLACK, 30)).IsFail())
                {
                    ErrorPrint(eResult,"Failed to draw text\n");
                    break;
                }

                if (( eResult = arrLayer[2].DrawTextCanvas(tpPosition, "MedianWeighted2 Inner", EColor.YELLOW, EColor.BLACK, 30)).IsFail())
                {
                    ErrorPrint(eResult,"Failed to draw text\n");
                    break;
                }
