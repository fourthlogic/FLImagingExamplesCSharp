...
namespace ReduceDimensionModeMultiPageTo2D
{
	class ReduceDimensionModeMultiPageTo2D
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				CResult res;
				// 이미지 로드 // Load image
				if((res = fliSourceImage.Load("../../ExampleImages/ReduceDimensionModeMultiPageTo2D/Source.flif")).IsFail())
				{
				...
				CReduceDimensionModeMultiPageTo2D reduceDimensionModeMultiPageTo2D = new CReduceDimensionModeMultiPageTo2D();

				// Source 이미지 설정 // Set source image 
				reduceDimensionModeMultiPageTo2D.SetSourceImage(ref fliSourceImage);

				// Destination 이미지 설정 // Set destination image
				reduceDimensionModeMultiPageTo2D.SetDestinationImage(ref fliDestinationImage);
