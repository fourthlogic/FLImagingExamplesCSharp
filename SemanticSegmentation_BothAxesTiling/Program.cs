	...
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				semanticSegmentation.SetModelVersion(CSemanticSegmentationDL.EModelVersion.FLSegNet_V1_256_B1);
				...
				String strStopConditon = "accuracy >= 0.99 | mIoU >= 0.75";
				semanticSegmentation.SetLearningStopCondition(strStopConditon);
				...
				semanticSegmentation.SetImageTilingMode(CSemanticSegmentationDL.ETilingMode.BothAxesTiling);
