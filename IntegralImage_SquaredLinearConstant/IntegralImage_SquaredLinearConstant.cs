...
{
	class IntegralImage_SquaredLinearConstant
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				CMultiVar<double> mvCoefficients = new CMultiVar<double>(1.7, 2.1, 1.5);
				...
				// ECalculationMode.SquaredLinearConstant : ax^2 + bx + c 형태의 다항식 누적합 // ECalculationMode.SquaredLinearConstant : Polynomial sum with constant (ax^2 + bx + c)
