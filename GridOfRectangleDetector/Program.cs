...
namespace CameraCalibrator
{
    class Program
	{
        ...
        static void Main(string[] args)
        {
            ...
            {
                // 이미지 로드 // Load image
                if ((eResult = fliImage.Load("../../ExampleImages/GridOfRectangleDetector/GridOfRectangle.flif")).IsFail())
                {
                ...
                if ((eResult = gridofRectangle.Execute()).IsFail())
                {
                ...
                gridofRectangle.GetResultCenterPoints(out flaPoints);
                gridofRectangle.GetResultForRegion(out flqRegion);
