	...
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				CResult eResult;
				// 이미지 로드 // Load image
				if((eResult = fliISrcImage.Load("../../ExampleImages/AnisotropicDiffusion/Source.flif")).IsFail())
				{
                ...
                if ((eResult = (WatershedsThresholdMarker.Execute())).IsFail())
				{
					ErrorPrint(eResult, "Failed to execute WatershedsThreshold.");
					break;
				}
