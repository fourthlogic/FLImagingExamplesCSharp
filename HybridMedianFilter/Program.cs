	...
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				// 이미지 로드 // Load image
				if ((res =fliSrcImage.Load("../../ExampleImages/MedianFilter/Chip_Noise.flif")).IsFail())
				{
				...
				CHybridMedianFilter hybridMedianFilter = new CHybridMedianFilter();

				// 처리할 이미지 설정 // Set the image to process
				hybridMedianFilter.SetSourceImage(ref fliSrcImage);
				...
				hybridMedianFilter.SetDestinationImage(ref fliDstImage);
				...
				if ((res =(res = hybridMedianFilter.Execute())).IsFail())
				{
