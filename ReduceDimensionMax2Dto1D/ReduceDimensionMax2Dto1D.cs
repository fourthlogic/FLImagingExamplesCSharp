	...
	class ReduceDimensionMax2Dto1D
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				CReduceDimensionMax2Dto1D reduceDimensionMax2Dto1D = new CReduceDimensionMax2Dto1D();

				// Source 이미지 설정 // Set source image 
				reduceDimensionMax2Dto1D.SetSourceImage(ref fliSourceImage);

				// Destination 이미지 설정 // Set destination image
				reduceDimensionMax2Dto1D.SetDestinationImage(ref fliDestinationImageX);
				...
				// Destination 이미지 설정 // Set destination image
				reduceDimensionMax2Dto1D.SetDestinationImage(ref fliDestinationImageY);
