	...
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				if((eResult = FLPatternMatchMultiSave.Save("../../ExampleImages/Matching/Pattern Multi Learn")).IsFail())
				{
				...
				if((eResult = FLPatternMatchMultiLoad.Load("../../ExampleImages/Matching/Pattern Multi Learn")).IsFail())
				{
				...
				FLPatternMatchMultiLoad.SetAngleTolerance(10.0);
				...
				// 알고리즘 수행 // Execute the Algoritm
				if((eResult = FLPatternMatchMultiLoad.Execute()).IsFail())
				{
				...
				for(long i = 0; i < i64ResultCount; ++i)
				{
					...
					FLPatternMatchMultiLoad.GetResult(i, out results);
