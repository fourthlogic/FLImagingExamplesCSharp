    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
	        ...
	        do
			{
	        	...
	        	if((eResult = layerSource.DrawFigureImage(flfaSourcePivotCrossHair, EColor.BLACK, 3)).IsFail())
                {
                    ErrorPrint(eResult,"Failed to draw figure. \n");
                    break;
                }

	        	if((eResult = layerSource.DrawFigureImage(flfaSourcePivotCrossHair, EColor.LIME)).IsFail())
                {
                    ErrorPrint(eResult,"Failed to draw figure. \n");
                    break;
                }
	        	...
	        	if((eResult = layerDestination.DrawFigureImage(flrDestinationROI, EColor.LIME)).IsFail())
                {
                    ErrorPrint(eResult,"Failed to draw figure. \n");
                    break;
                }
