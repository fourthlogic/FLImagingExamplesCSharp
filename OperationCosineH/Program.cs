	...
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				CResult eResult;
				// 이미지 로드 // Load image
                if ((eResult = (arrFliImage[0].Load("../../ExampleImages/OperationCosineH/Flower.flif"))).IsFail())
				{
				...
				{
					ErrorPrint(eResult, "Failed to execute operation CosineH.");
					break;
				}
