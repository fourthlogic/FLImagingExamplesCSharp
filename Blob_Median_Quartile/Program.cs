		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				for(Int64 i = 0; i < i64ResultCount; ++i)
				{
					...
					if((eResult = imgStatistics.GetMedian(out mvMedian)).IsFail())
					{
					...
					if((eResult = imgStatistics.GetLowerQuartile(out mvLowerQuartile)).IsFail())
					{
					...
					if((eResult = imgStatistics.GetUpperQuartile(out mvUpperQuartile)).IsFail())
					{
