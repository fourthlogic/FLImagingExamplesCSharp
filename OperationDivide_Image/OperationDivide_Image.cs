	...
	class OperationDivide_Image
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				if((res = fliSourceImage.Load("../../ExampleImages/OperationDivide/Moon.flif")).IsFail())
				{
				...
				if((res = fliOperandImage.Load("../../ExampleImages/OperationDivide/FlowerWall.flif")).IsFail())
				{
					ErrorPrint(res, "Failed to load the image file. \n");
					break;
				}
				...
				operationDivide.SetOperandImage(ref fliOperandImage);

				// Destination 이미지 설정 // Set the destination image
				operationDivide.SetDestinationImage(ref fliDestinationImage);
