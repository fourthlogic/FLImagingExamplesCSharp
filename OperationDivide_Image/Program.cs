	...
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				if((eResult = fliSourceImage.Load("../../ExampleImages/OperationDivide/Moon.flif")).IsFail())
				{
				...
				if((eResult = fliOperandImage.Load("../../ExampleImages/OperationDivide/FlowerWall.flif")).IsFail())
				{
					ErrorPrint(eResult, "Failed to load the image file. \n");
					break;
				}
