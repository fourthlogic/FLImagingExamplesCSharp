			...
			do
			{
				...
				while(true)
				{
					...
					if(i32Epoch != i32PrevEpoch && i32Iteration == i32MiniBatchCount && i32Epoch > 0)
					{
						...
						fasterCharacterBasedOCRDL.GetLearningResultAllHistory(ref vctCosts, ref vctValidations, ref vctMeanIoU, ref vctValidationsZE, ref vctMeanIoUZE, ref vctMeanAP, ref vctValidationEpoch);
