	...
	class OperationMish
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				if((res = algObject.SetOperationMode(COperationMish.EOperationMode.Forward)).IsFail()) break;
				...
				if((res = algObject.SetOperationMode(COperationMish.EOperationMode.Backward)).IsFail()) break;
