...
namespace MorphologyTopHat
{
	class MorphologyTopHat_Kernel
	{
		...
		static void Main(string[] args)
		{
			...
			{
				// 이미지 로드 // Load image
				if((res = arrFliImage[(int)EType.Source].Load("../../ExampleImages/Morphology/Flower.flif")).IsFail())
				{
				...
				for(int i = (int)EType.Destination; i < (int)EType.ETypeCount; ++i)
				{
