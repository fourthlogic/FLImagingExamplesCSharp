...
namespace Morphology_Gradient
{
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			{
				// 이미지 로드 // Load image
				if((eResult = arrFliImage[(int)EType.Source].Load("../../ExampleImages/Morphology/Moss.flif")).IsFail())
				{
                ...
                morphologyGradient.SetKernelShape(CMorphologyGradient.EKernelShape.Circle);
