    ...
    class Program
	{
        ...
        static void Main(string[] args)
        {
			...
			do
			{
                ...
                CFLEllipse<double> measureRegion = new CFLEllipse<double>(180.071947, 102.600690, 10.505232, 36.645048, -70.682726);
				...
				ellipseGauge.SetTransitionType(CEllipseGauge.ETransitionType.DarkToBrightOrBrightToDark);
				...
				ellipseGauge.SetTransitionChoice(CEllipseGauge.ETransitionChoice.Closest);
                ...
                float f64Radius1 = new float(), f64Radius2 = new float();
