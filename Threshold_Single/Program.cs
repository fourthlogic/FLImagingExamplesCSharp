	...
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				CResult eResult;
				// 이미지 로드 // Load image
				if((eResult = fliISrcImage.Load("../../ExampleImages/Threshold/Mountain.flif")).IsFail())
				{
				...
				if((eResult = (AbsoluteThreshold.Execute())).IsFail())
				{
					ErrorPrint(eResult, "Failed to execute AbsoluteThreshold.");
					break;
				}
