        ...
        static void Main(string[] args)
        {
			...
			do
			{
                ...
                for (int i = 0; i < 3; ++i)
                {
					...
					for(int i64Row = 0; i64Row < i64GridRow; ++i64Row)
					{
						TPoint<double> tpGridPoint1 = (sArrGridDisplay[i].sGridData.arrGridData[i64Row][0]);
						TPoint<double> tpGridPoint2 = (sArrGridDisplay[i].sGridData.arrGridData[i64Row][1]);
						...
						for(int i64Col = 0; i64Col < i64GridCol; ++i64Col)
						{
							...
							{
								tpGridPoint1 = (sArrGridDisplay[i].sGridData.arrGridData[i64Row][i64Col]);
								tpGridPoint2 = (sArrGridDisplay[i].sGridData.arrGridData[i64Row][i64Col + 1]);
							...
							{
								tpGridPoint1 = (sArrGridDisplay[i].sGridData.arrGridData[i64Row][i64Col]);
								tpGridPoint2 = (sArrGridDisplay[i].sGridData.arrGridData[i64Row - 1][i64Col]);
							...
							{
								tpGridPoint1 = (sArrGridDisplay[i].sGridData.arrGridData[0][i64Col]);
								tpGridPoint2 = (sArrGridDisplay[i].sGridData.arrGridData[1][i64Col]);
