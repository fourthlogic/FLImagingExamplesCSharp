	...
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				if((res = CAutoLabelerDL.Execute(ref fliResultAutotLabelImage, semanticSegmentation, true, true, CAutoLabelerDL.ELabelOptions.ClassName_RegionType_BoundaryRect)).IsFail())
				{
