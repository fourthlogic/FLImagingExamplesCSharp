...
{
	class OperationInvertIntensity
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				CResult res;
				// 이미지 로드 // Load image
                if ((res = (arrFliImage[0].Load("../../ExampleImages/OperationInvertIntensity/board.flif"))).IsFail())
				{
				...
				operationInvertIntensity.SetSourceImage(ref arrFliImage[0]);
				// Destination 이미지 설정 // Set destination image 
				operationInvertIntensity.SetDestinationImage(ref arrFliImage[1]);
