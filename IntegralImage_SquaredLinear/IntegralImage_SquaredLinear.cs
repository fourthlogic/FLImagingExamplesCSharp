...
{
	class IntegralImage_SquaredLinear
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				// ECalculationMode.SquaredLinear : ax^2 + bx 형태의 다항식 누적합 // ECalculationMode.SquaredLinear : Polynomial sum (ax^2 + bx)
				integralImage.SetCalculationMode(CIntegralImage.ECalculationMode.SquaredLinear);
