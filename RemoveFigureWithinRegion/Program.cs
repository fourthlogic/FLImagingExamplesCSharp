...
namespace RemoveFigureWithinRegion
{
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				DstLayer0.DrawTextCanvas(new TPoint<double>(0, 0), "Remove Figure Within Region1", EColor.YELLOW, EColor.BLACK, 15);
				SrcLayer1.DrawTextCanvas(new TPoint<double>(0, 0), "Source Figure And Region2", EColor.YELLOW, EColor.BLACK, 15);
				DstLayer1.DrawTextCanvas(new TPoint<double>(0, 0), "Remove Figure Within Region2", EColor.YELLOW, EColor.BLACK, 15);
