...
namespace ReduceDimensionMaxMultiPageTo2D
{
	class ReduceDimensionMaxMultiPageTo2D
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				CResult res;
				// 이미지 로드 // Load image
				if((res = fliSourceImage.Load("../../ExampleImages/ReduceDimensionMaxMultiPageTo2D/Source.flif")).IsFail())
				{
				...
				CReduceDimensionMaxMultiPageTo2D reduceDimensionMaxMultiPageTo2D = new CReduceDimensionMaxMultiPageTo2D();

				// Source 이미지 설정 // Set source image 
				reduceDimensionMaxMultiPageTo2D.SetSourceImage(ref fliSourceImage);

				// Destination 이미지 설정 // Set destination image
				reduceDimensionMaxMultiPageTo2D.SetDestinationImage(ref fliDestinationImage);
