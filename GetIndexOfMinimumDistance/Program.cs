...
namespace GetIndexOfMinimumDistance
{
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				if((eResult = flpaSource1.GetIndexOfMinimumDistance(flcDestination1, out flfaResultSrc1)).IsFail())
				{
				...
				if((eResult = flfaSource2.GetIndexOfMinimumDistance(flfaDestination2, out flfaResultSrc2, true, true, out flfaResultDst2)).IsFail())
				{
					ErrorPrint(eResult, "Failed to process.\n");
					break;
				}
