	...
	class OperationHardShrinkage
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				if((res = algObject.SetOperationMode(COperationHardShrinkage.EOperationMode.Forward)).IsFail()) break;
				...
				if((res = algObject.SetOperationMode(COperationHardShrinkage.EOperationMode.Backward)).IsFail()) break;
