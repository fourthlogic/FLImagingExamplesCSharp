    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
				...
				if ((eResult = arrFliImage[0].Load("../../ExampleImages/FreiFilter/Gear.flif")).IsFail())
                {
                ...
                CFreiFilter edgeEnhancement = new CFreiFilter();
                ...
                {
                    ErrorPrint(eResult, "Failed to execute FreiFilter.");
