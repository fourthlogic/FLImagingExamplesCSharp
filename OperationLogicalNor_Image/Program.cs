    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
			...
			do
            {
                ...
                if ((eResult = fliSourceImage.Load("../../ExampleImages/OperationLogicalNor/circle.flif")).IsFail())
                {
                ...
                if ((eResult = fliOperandImage.Load("../../ExampleImages/OperationLogicalNor/square.flif")).IsFail())
                {
                    ErrorPrint(eResult, "Failed to load the image file. \n");
                    break;
                }
