	...
	class VoxelGrid3D
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				if((eResult = floSourceObject.Load("../../ExampleImages/VoxelGrid3D/VoxelGrid3DExample.ply")).IsFail())
				{
				...
				voxelGrid3D.SetDestinationObject(ref floDestinationObject);
				// Source object 설정 // Set the source object
				voxelGrid3D.SetSourceObject(ref floSourceObject);
				...
				{
					ErrorPrint(eResult, "Failed to execute Voxel Grid 3D.");
					break;
				}
