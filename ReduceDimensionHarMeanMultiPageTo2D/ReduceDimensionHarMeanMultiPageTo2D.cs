...
namespace ReduceDimensionHarMeanMultiPageTo2D
{
	class ReduceDimensionHarMeanMultiPageTo2D
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				CResult res;
				// 이미지 로드 // Load image
				if((res = fliSourceImage.Load("../../ExampleImages/ReduceDimensionHarMeanMultiPageTo2D/Source.flif")).IsFail())
				{
