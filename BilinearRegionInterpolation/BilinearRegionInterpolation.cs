...
{
	class BilinearRegionInterpolation
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				bilinearRegionInterpolation.EnableImageFiguresAsInterpolationRegions(true);
				...
				if((res = (arrLayer[(int)EType.Destination].DrawTextCanvas(flpZero, "Destination Image (Bilinear)", EColor.YELLOW, EColor.BLACK, 20))).IsFail())
				{
					ErrorPrint(res, "Failed to draw text.\n");
					break;
				}
