...
{
	class GetPointsOfMinimumDistance
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				layerDst1.DrawTextCanvas(new TPoint<double>(0, 20), "Minimum Distance", EColor.CYAN, EColor.BLACK);
				layerDst2.DrawTextCanvas(new TPoint<double>(0, 20), "Minimum Distance", EColor.CYAN, EColor.BLACK);
				...
				layerDst1.DrawFigureImage(fllMin1, EColor.CYAN);
				layerDst1.DrawTextImage(fllMin1.GetCenter(), String.Format("{0:.000}", f64MinimumDistance1), EColor.CYAN, EColor.BLACK, 12, false, 0, EGUIViewImageTextAlignment.RIGHT_TOP);
				...
				layerDst2.DrawFigureImage(fllMin2, EColor.CYAN);
				layerDst2.DrawTextImage(fllMin2.GetCenter(), String.Format("{0:.000}", f64MinimumDistance2), EColor.CYAN, EColor.BLACK, 12, false, 0, EGUIViewImageTextAlignment.LEFT_BOTTOM);
