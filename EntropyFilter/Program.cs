    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
			...
			do
	        {
                ...
                if ((eResult = fliSourceImage.Load("../../ExampleImages/EntropyFilter/Cat3Ch.flif")).IsFail())
                {
                ...
                if ((eResult = fliDestinationImage.Load("../../ExampleImages/EntropyFilter/Cat3Ch.flif")).IsFail())
                {
                    ErrorPrint(eResult, "Failed to load the image file. \n");
                    break;
                }
				...
				CEntropyFilter entropyFilter = new CEntropyFilter();

				// Source 이미지 설정 // Set the source image
				entropyFilter.SetSourceImage(ref fliSourceImage);

				// Destination 이미지 설정 // Set the destination image
				entropyFilter.SetDestinationImage(ref fliDestinationImage);
