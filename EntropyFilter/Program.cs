    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
			...
			do
	        {
                ...
                if ((res = fliSourceImage.Load("../../ExampleImages/EntropyFilter/Cat3Ch.flif")).IsFail())
                {
                ...
                if ((res = fliDestinationImage.Load("../../ExampleImages/EntropyFilter/Cat3Ch.flif")).IsFail())
                {
                    ErrorPrint(res, "Failed to load the image file. \n");
                    break;
                }
