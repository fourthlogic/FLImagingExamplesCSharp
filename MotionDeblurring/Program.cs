	...
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				if((eResult = arrFliImage[0].Load("../../ExampleImages/MotionDeblurring/CircuitBlur.flif")).IsFail())
				{
				...
				CMotionDeblurring MotionDeblurring = new CMotionDeblurring();
				// Source 이미지 설정 // Set the source image
				MotionDeblurring.SetSourceImage(ref arrFliImage[0]);
				// Destination 이미지 설정 // Set the destination image
				MotionDeblurring.SetDestinationImage(ref arrFliImage[1]);
