...
namespace ReduceDimensionStdevMultiPageTo2D
{
	class ReduceDimensionStdevMultiPageTo2D
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				CResult res;
				// 이미지 로드 // Load image
				if((res = fliSourceImage.Load("../../ExampleImages/ReduceDimensionStdevMultiPageTo2D/Source.flif")).IsFail())
				{
				...
				CReduceDimensionStdevMultiPageTo2D reduceDimensionStdevMultiPageTo2D = new CReduceDimensionStdevMultiPageTo2D();

				// Source 이미지 설정 // Set source image 
				reduceDimensionStdevMultiPageTo2D.SetSourceImage(ref fliSourceImage);

				// Destination 이미지 설정 // Set destination image
				reduceDimensionStdevMultiPageTo2D.SetDestinationImage(ref fliDestinationImage);
