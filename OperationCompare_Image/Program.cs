    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                if ((result = arrFliImage[0].Load("../../ExampleImages/OperationCompare/candle.flif")).IsFail())
                {
                ...
                if ((result = arrFliImage[1].Load("../../ExampleImages/OperationCompare/filter.flif")).IsFail())
                {
                    ErrorPrint(result, "Failed to load the image file.\n");
                    break;
                }
