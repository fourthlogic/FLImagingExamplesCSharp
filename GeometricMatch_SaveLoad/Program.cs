	...
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				if((eResult = FLGeometricMatchSave.Learn()).IsFail())
				{
				...
				if((eResult = FLGeometricMatchSave.Save("../../ExampleImages/Matching/Geometric Single Learn")).IsFail())
				{
				...
				if((eResult = FLGeometricMatchSave.GetLearntFeature(out flfaFeaturePoints)).IsFail())
				{
				...
				if((eResult = FLGeometricMatchLoad.Load("../../ExampleImages/Matching/Geometric Single Learn")).IsFail())
				{
					ErrorPrint(eResult, "Failed to save\n");
					break;
				}
				...
				FLGeometricMatchLoad.SetConstrastOption(FLImagingCLR.AdvancedFunctions.EGeometricMatchConstrastOption.Normal);
				...
				FLGeometricMatchLoad.SetFindThresholdCoeff(1.0);
