    ...
    class Program
	{
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                if ((eResult = fliLearnImage.Load("../../ExampleImages/OrthogonalCalibrator/Orthogonal_ChessBoard.flif")).IsFail())
                {
                ...
                if ((eResult = fliSourceImage.Load("../../ExampleImages/OrthogonalCalibrator/Orthogonal_ChessBoard.flif")).IsFail())
                {
                    ErrorPrint(eResult, "Failed to load the image file.");
                    break;
                }
