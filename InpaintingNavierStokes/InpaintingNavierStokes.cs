...
namespace InpaintingNavierStokes
{
	class InpaintingNavierStokes
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				if((res = arrFliImage[0].Load("../../ExampleImages/InpaintingNavierStokes/Dandelion.flif")).IsFail())
				{
				...
				if((res = flfaInpaintingRegion.Load("../../ExampleImages/InpaintingNavierStokes/InpaintingRegionDandelion.fig")).IsFail())
				{
