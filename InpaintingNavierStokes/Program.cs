	...
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				if((eResult = arrFliImage[0].Load("../../ExampleImages/InpaintingNavierStokes/Dandelion.flif")).IsFail())
				{
				...
				if((eResult = flfaInpaintingRegion.Load("../../ExampleImages/InpaintingNavierStokes/InpaintingRegionDandelion.fig")).IsFail())
				{
