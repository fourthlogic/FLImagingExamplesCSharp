    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                if ((eResult = arrFliImage[0].Load("../../ExampleImages/MeanCurvatureFlow/Sea3Ch.flif")).IsFail())
                {
                ...
                // SoeResult = urce 이미지 뷰 생성 // Create source image view
                ...
                CMeanCurvatureFlow MeanCurvatureFlow = new CMeanCurvatureFlow();
                // Source 이미지 설정 // Set the source image
                MeanCurvatureFlow.SetSourceImage(ref arrFliImage[0]);
                // Destination 이미지 설정 // Set the destination image
                MeanCurvatureFlow.SetDestinationImage(ref arrFliImage[1]);
