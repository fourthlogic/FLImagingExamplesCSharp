...
{
	class ReduceDimensionMedian2Dto1D
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				CReduceDimensionMedian2Dto1D reduceDimensionMedian2Dto1D = new CReduceDimensionMedian2Dto1D();

				// Source 이미지 설정 // Set source image 
				reduceDimensionMedian2Dto1D.SetSourceImage(ref fliSourceImage);

				// Destination 이미지 설정 // Set destination image
				reduceDimensionMedian2Dto1D.SetDestinationImage(ref fliDestinationImageX);
				...
				// Destination 이미지 설정 // Set destination image
				reduceDimensionMedian2Dto1D.SetDestinationImage(ref fliDestinationImageY);
