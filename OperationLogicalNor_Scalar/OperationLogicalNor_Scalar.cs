...
{
	class OperationLogicalNor_Scalar
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				if((res = fliSourceImage.Load("../../ExampleImages/OperationLogicalNor/Cat.flif")).IsFail())
				{
				...
				operationLogicalNor.SetSourceImage(ref fliDestinationImage);
				...
				operationLogicalNor.SetScalarValue(000);
