...
namespace Morphology_Close
{
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			{
				// 이미지 로드 // Load image
				if((eResult = arrFliImage[(int)EType.Source].Load("../../ExampleImages/Morphology/Chip_Noise.flif")).IsFail())
				{
				...
				morphologyClose.SetKernelShape(CMorphologyClose.EKernelShape.Circle);
