	...
	class ContrastEnhancement
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				CResult res;
				// 이미지 로드 // Load image
				if((res = fliSourceImage.Load("../../ExampleImages/ContrastEnhancement/Moon.flif")).IsFail())
				{
				...
				CContrastEnhancement contrastEnhancement = new CContrastEnhancement();

				// Source 이미지 설정 // Set source image 
				contrastEnhancement.SetSourceImage(ref fliSourceImage);
