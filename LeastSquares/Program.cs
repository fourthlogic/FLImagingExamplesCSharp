        ...
        static void Main(string[] args)
        {
	        ...
	        while(true)
	        {
		        do 
		        {
			        ...
			        for(int i = 1; i <= 5; ++i)
					{
						// 계수 값을 받기 위해 Array 생성 // Create Array to receive coefficient values
						double[] arrF64Output = new double[i + 1];
				        ...
				        int i32Count = arrF64Output.Length;
