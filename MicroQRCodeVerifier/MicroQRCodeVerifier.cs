	...
	class MicroQRCodeVerifier
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				CMicroQRCodeVerifier qrCodeVerifier = new CMicroQRCodeVerifier();
				...
				for(Int64 i = 0; i < i64Results; ++i)
				{
					...
					// MicroQR Code Verifier 결과를 얻어오기 위해 string 선언
					...
					qrCodeVerifier.GetResultMicroQRCodeSpec(i, ref codeSpec);
					...
					CMicroQRCodePrintQuality_ISOIEC_15415 printQuality = new CMicroQRCodePrintQuality_ISOIEC_15415();
