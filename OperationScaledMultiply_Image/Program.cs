	...
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				if((res = arrFliImage[(int)EType.Source].Load("../../ExampleImages/OperationScaledMultiply/Generator.flif")).IsFail())
				{
				...
				if((res = arrFliImage[(int)EType.Operand].Load("../../ExampleImages/OperationScaledMultiply/Gradation_R2W.flif")).IsFail())
				{
					ErrorPrint(res, "Failed to load the image file.\n");
					break;
				}
