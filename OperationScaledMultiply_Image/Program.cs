	...
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				if((eResult = arrFliImage[(int)EType.Source].Load("../../ExampleImages/OperationScaledMultiply/Generator.flif")).IsFail())
				{
				...
				if((eResult = arrFliImage[(int)EType.Operand].Load("../../ExampleImages/OperationScaledMultiply/Gradation_R2W.flif")).IsFail())
				{
					ErrorPrint(eResult, "Failed to load the image file.\n");
					break;
				}
