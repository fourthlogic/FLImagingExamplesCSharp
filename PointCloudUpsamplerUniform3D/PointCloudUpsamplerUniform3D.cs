...
{
	class PointCloudUpsamplerUniform3D
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				CPointCloudUpsamplerUniform3D pointCloudUpsamplerUniform3D = new CPointCloudUpsamplerUniform3D();
				...
				// 앞서 설정된 파라미터 대로 알고리즘 수행 // Execute pointCloudUpsamplerUniform3Dorithm according to previously set parameters
