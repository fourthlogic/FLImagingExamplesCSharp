	...
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				if((res = (arrLayer[1].DrawTextCanvas(tpPosition, "Destination1 Image(Minimum 100)", EColor.YELLOW, EColor.BLACK, 25))).IsFail())
				{
					ErrorPrint(res, "Failed to draw text.\n");
					break;
				}

				if((res = (arrLayer[2].DrawTextCanvas(tpPosition, "Destination2 Image(Minimum 200)", EColor.YELLOW, EColor.BLACK, 25))).IsFail())
				{
					ErrorPrint(res, "Failed to draw text.\n");
					break;
				}
