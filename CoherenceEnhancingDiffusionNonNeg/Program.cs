	...
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				CResult eResult;
				// 이미지 로드 // Load image
				if((eResult = fliISrcImage.Load("../../ExampleImages/CoherenceEnhancingDiffusion/fingerprint.flif")).IsFail())
				{
				...
				{
					ErrorPrint(eResult, "Failed to execute Coherence Enhancing Diffusion Non Neg.");
					break;
				}
