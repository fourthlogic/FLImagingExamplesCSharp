	...
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				layer[1].DrawTextCanvas(new CFLPoint<int>(0, 0), "Erode Result1", EColor.YELLOW, EColor.BLACK, 30);
				layer[2].DrawTextCanvas(new CFLPoint<int>(0, 0), "Erode Result2", EColor.YELLOW, EColor.BLACK, 30);
				layer[3].DrawTextCanvas(new CFLPoint<int>(0, 0), "Erode Result2", EColor.YELLOW, EColor.BLACK, 30);
