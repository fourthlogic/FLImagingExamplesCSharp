...
namespace DeviceCameraRealSense
{
    ...
    public class CDeviceEventImageEx : CDeviceEventImageBase
    {
        ...
        public override void OnAcquisition(CDeviceImageBase pDeviceImage)
        {
            do
            {
                ...
                CDeviceCameraRealSense camera = pDeviceImage as CDeviceCameraRealSense;
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
	        ...
	        // RealSense 카메라 선언
	        CDeviceCameraRealSense camRealSense = new CDeviceCameraRealSense();
	        ...
	        do
	        {
		        ...
		        if(bAutoDetect)
		        {
                    ...
                    drResult = camRealSense.GetAutoDetectCameraSerialNumbers(out listSerialNumbers);
		        ...
		        if(bAutoDetect)
                    ...
                    drResult = camRealSense.AutoDetectCamera(i32SelectDevice);
		        else
                    // 시리얼 번호를 설정합니다.
                    camRealSense.SetSerialNumber(strConnection);

		        // 카메라를 초기화 합니다.
                drResult = camRealSense.Initialize();
