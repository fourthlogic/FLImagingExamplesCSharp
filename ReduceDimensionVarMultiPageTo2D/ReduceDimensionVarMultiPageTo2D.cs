...
namespace ReduceDimensionVarMultiPageTo2D
{
	class ReduceDimensionVarMultiPageTo2D
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				CReduceDimensionVarMultiPageTo2D reduceDimensionVarMultiPageTo2D = new CReduceDimensionVarMultiPageTo2D();

				// Source 이미지 설정 // Set source image 
				reduceDimensionVarMultiPageTo2D.SetSourceImage(ref fliSourceImage);

				// Destination 이미지 설정 // Set destination image
				reduceDimensionVarMultiPageTo2D.SetDestinationImage(ref fliDestinationImage);
