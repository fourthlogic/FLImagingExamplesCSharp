...
{
    class ConditionalExtractor_Image_Single
    {
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                if ((res = arrFliImage[1].Load("../../ExampleImages/ConditionalExtractor/CatOperand.flif")).IsFail())
                {
                    ErrorPrint(res, "Failed to load the image file.\n");
                    break;
                }
                ...
                if ((res = arrLayer[2].DrawTextCanvas(tpPosition, "Destination Image\nSingle(Less)", EColor.YELLOW, EColor.BLACK, 30)).IsFail())
                {
                    ErrorPrint(res, "Failed to draw text.\n");
                    break;
                }
