	...
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				if((eResult = arrFliImage[0].Load("../../ExampleImages/ThinPlateSplineWarping/Undistortion.flif")).IsFail())
				{
				...
				{
					ErrorPrint(eResult, "Failed to calibrate ThinPlateSplineWarping.");
				...
				{
					ErrorPrint(eResult, "Failed to execute ThinPlateSplineWarping.");
					Console.WriteLine(eResult.GetString());
					break;
				}
