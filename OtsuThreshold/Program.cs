	...
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				CResult eResult;
				// 이미지 로드 // Load image
				if((eResult = fliISrcImage.Load("../../ExampleImages/Threshold/BallChip.flif")).IsFail())
				{
				...
				if((eResult = (OtsuThreshold.Execute())).IsFail())
				{
					ErrorPrint(eResult, "Failed to execute OtsuThreshold.");
					break;
				}
