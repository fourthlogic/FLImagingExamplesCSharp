    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
			...
			do
	        {
                ...
                if ((eResult = fliSourceImage.Load("../../ExampleImages/SymmetryFilter/Monkey.flif")).IsFail())
                {
                ...
                if ((eResult = fliDestinationImage.Load("../../ExampleImages/SymmetryFilter/Monkey.flif")).IsFail())
                {
                    ErrorPrint(eResult, "Failed to load the image file. \n");
                    break;
                }
				...
				CSymmetryFilter symmetryFilter = new CSymmetryFilter();

				// Source 이미지 설정 // Set the source image
				symmetryFilter.SetSourceImage(ref fliSourceImage);
				...
				symmetryFilter.SetPaddingMethod(EPaddingMethod.DecreasingKernel);
