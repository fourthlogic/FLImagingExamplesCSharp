    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                CMorphologyOpen morphologyOpen = new CMorphologyOpen();
                // Source 이미지 설정 // Set the source image
                morphologyOpen.SetSourceImage(ref arrFliImage[(int)EType.Source]);
                // Source ROI 설정 // Set the Source ROI
                morphologyOpen.SetSourceROI(flrROI);

                // Destination 이미지 설정 // Set the destination image
                morphologyOpen.SetDestinationImage(ref arrFliImage[(int)EType.Destination]);
				...
				morphologyOpen.SetKernel(flrRegion);

                // 앞서 설정된 파라미터 대로 알고리즘 수행 // Execute algorithm according to previously set parameters
                if ((eResult = (morphologyOpen.Execute())).IsFail())
                {
