...
{
	class ReduceDimensionGeoMean2Dto1D
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				CResult res;
				// 이미지 로드 // Load image
				if((res = fliSourceImage.Load("../../ExampleImages/ReduceDimensionGeoMean2Dto1D/Source.flif")).IsFail())
				{
				...
				CReduceDimensionGeoMean2Dto1D reduceDimensionGeoMean2Dto1D = new CReduceDimensionGeoMean2Dto1D();

				// Source 이미지 설정 // Set source image 
				reduceDimensionGeoMean2Dto1D.SetSourceImage(ref fliSourceImage);

				// Destination 이미지 설정 // Set destination image
				reduceDimensionGeoMean2Dto1D.SetDestinationImage(ref fliDestinationImageX);

				// 축소 차원 설정 // Set reduction dimension
				reduceDimensionGeoMean2Dto1D.SetReductionDimension(CReduceDimensionGeoMean2Dto1D.EReductionDimension.X);
				...
				// Destination 이미지 설정 // Set destination image
				reduceDimensionGeoMean2Dto1D.SetDestinationImage(ref fliDestinationImageY);

				// 축소 차원 설정 // Set reduction dimension
				reduceDimensionGeoMean2Dto1D.SetReductionDimension(CReduceDimensionGeoMean2Dto1D.EReductionDimension.Y);
				...
				viewImageDestinationX.Destroy();
				viewImageDestinationY.Destroy();
			}
			while(false);
		}
	}
