...
namespace Convolution_Gaussian
{
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			{
				// 이미지 로드 // Load image
				if((eResult = arrFliImage[(int)EType.Source].Load("../../ExampleImages/Convolution/Flower.flif")).IsFail())
				{
				...
				CConvolutionGaussian convolutionGaussian = new CConvolutionGaussian();
				// Source 이미지 설정 // Set the source image
				convolutionGaussian.SetSourceImage(ref arrFliImage[(int)EType.Source]);
				// Source ROI 설정 // Set the Source ROI
				convolutionGaussian.SetSourceROI(flrROI);

				// Destination1 이미지 설정 // Set the destination1 image
				convolutionGaussian.SetDestinationImage(ref arrFliImage[(int)EType.Destination1]);
				...
				if((eResult = (convolutionGaussian.Execute())).IsFail())
				{
				...
				convolutionGaussian.SetDestinationImage(ref arrFliImage[(int)EType.Destination2]);
				...
				convolutionGaussian.SetDestinationImage(ref arrFliImage[(int)EType.Destination3]);
				...
				convolutionGaussian.SetDestinationImage(ref arrFliImage[(int)EType.Destination4]);
