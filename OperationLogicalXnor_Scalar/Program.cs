    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                if ((eResult = layerDestination1.DrawTextCanvas(flpPoint, "Destination1 Image(LogicalXnor 0)", EColor.YELLOW, EColor.BLACK, 30)).IsFail())
                {
                    ErrorPrint(eResult, "Failed to draw text. \n");
                    break;
                }

                if ((eResult = layerDestination2.DrawTextCanvas(flpPoint, "Destination2 Image(LogicalXnor 255)", EColor.YELLOW, EColor.BLACK, 30)).IsFail())
                {
                    ErrorPrint(eResult, "Failed to draw text. \n");
                    break;
                }
