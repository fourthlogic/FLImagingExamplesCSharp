...
{
	class LowLuminanceCorrectionType1
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				CResult res;
				// 이미지 로드 // Load image
				if((res = (arrFliImage[0].Load("../../ExampleImages/FLLowLuminanceCorrectionType1/FLLowLuminanceCorrectionType1.flif"))).IsFail())
				{
				...
				// FLLowLuminanceCorrectionType1 객체 생성 // Create FLLowLuminanceCorrectionType1 object
				CFLLowLuminanceCorrectionType1 flLowLuminanceCorrectionType1 = new CFLLowLuminanceCorrectionType1();
				// Source 이미지 설정 // Set source image
				flLowLuminanceCorrectionType1.SetSourceImage(ref arrFliImage[0]);
				// Destination 이미지 설정 // Set destination image 
				flLowLuminanceCorrectionType1.SetDestinationImage(ref arrFliImage[1]);
				// Noise Reduction 설정
