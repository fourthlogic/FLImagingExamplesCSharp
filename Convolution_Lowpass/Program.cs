	...
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				CConvolutionLowpass convolutionLowpass = new CConvolutionLowpass();
				// Source 이미지 설정 // Set the source image
				convolutionLowpass.SetSourceImage(ref arrFliImage[(int)EType.Source]);
				// Source ROI 설정 // Set the Source ROI
				convolutionLowpass.SetSourceROI(flrROI);

				// Destination1 이미지 설정 // Set the destination1 image
				convolutionLowpass.SetDestinationImage(ref arrFliImage[(int)EType.Destination1]);
				...
				convolutionLowpass.SetDestinationImage(ref arrFliImage[(int)EType.Destination2]);
