	...
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			do
			{
				...
				if((cResult = viewImage[0].SynchronizePointOfView(viewImage[1])).IsFail())
				{
				...
				if((cResult = viewImage[0].SynchronizeWindow(viewImage[1])).IsFail())
				{
				...
				viewImage[0].SetOffset(new CFLPoint<double>(-120, -35));
